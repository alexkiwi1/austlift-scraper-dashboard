module.exports = {
  ...
  rules: {
    ...
    'max-depth': ['warn', 4],
    'max-lines': ['warn', 700], // Increased for dashboard component with progress tracking
    'max-lines-per-function': ['warn', 700], // Increased for dashboard component with progress tracking
    'max-params': ['warn', 4],
