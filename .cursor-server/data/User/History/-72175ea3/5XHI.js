      ...
      <div className='flex-1 flex flex-col'>
        ...
        <div className='flex-1 p-6'>
                  ...
                  <div className='border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow'>
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='flex items-center space-x-4'>
                            ...
                            try {
                              ...
                              if (allCategoryIds.length > 0) {
                                ...
                                try {
                                  ...
                                  // Store products for popup
                                  setPopupProducts(data.products || []);
                                  setPopupTitle(`Scraped Products (${data.products.length} total)`);
                                } catch (err) {
                                  setStep4Status(
                        ...
                        {/* Info Button - Show when CSV is generated */}
                        {step4Status && step4Status.includes('CSV generated!') && (
                          <button
                            type='button'
                            onClick={() => setShowProductPopup(true)}
                            className='px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2'
          ...
          <div>
            ...
            {/* Product Info Table - Inline Display */}
            {showProductPopup && (
                ...
                {popupProducts.length > 0 ? (
                  <div className='overflow-x-auto'>
                    <table className='min-w-full divide-y divide-gray-200'>
                      ...
                      <tbody className='bg-white divide-y divide-gray-200'>
                        {popupProducts.slice(0, 50).map((product, index) => (
                    ...
                    {popupProducts.length > 50 && (
                      <div className='mt-4 text-center text-sm text-gray-500'>
                        Showing first 50 of {popupProducts.length} products
                      </div>
                    )}
                  </div>
                ) : (
              ...
              <div className='flex items-center justify-between p-4 border-t border-gray-200 bg-gray-50'>
                <div className='text-sm text-gray-600'>
                  Showing {Math.min(popupProducts.length, 50)} of {popupProducts.length} products
                </div>
