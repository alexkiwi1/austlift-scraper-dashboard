                            ...
                            try {
                              ...
                              if (allCategoryIds.length > 0) {
                                ...
                                try {
                                  ...
                                  const allCategoryUrls = categories.map(cat => cat.url);
                                  
                                  if (allCategoryUrls.length === 0) {
                                    setStep3Status('❌ No categories available to scrape');
                                    return;
                                  }
                                  ...
                                  if (data.job_id && data.status) {
                                    ...
                                    setStep3Status(`❌ Error: ${data.error || 'Failed to start scraping job'}`);
                                    return;
                                  }
                                } catch (err) {
                            ...
                            try {
                              ...
                              if (allCategoryIds.length > 0) {
                                ...
                                try {
                                  ...
                                  if (allCategoryUrls.length === 0) {
                                    setStep4Status('❌ No categories available to scrape');
                                    return;
                                  }
                                  ...
                                  if (data.job_id && data.status) {
                                    ...
                                    setStep4Status(`❌ Error: ${data.error || 'Failed to start scraping job'}`);
                                    return;
                                  }
                                } catch (err) {
