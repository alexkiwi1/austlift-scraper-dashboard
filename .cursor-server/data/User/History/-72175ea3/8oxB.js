...
import { Home, XCircle, Download } from 'lucide-react';
...
const AustliftScraperDashboard = () => {
  ...
  const handleStep4 = async () => {
    ...
    setStep4Status('Loading products for table display...');
    try {
      ...
      setStep4Status(
        `✅ Products loaded! Showing ${data.products.length} of ${data.total || data.products.length} products`
      );
