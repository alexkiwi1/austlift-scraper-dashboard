...
import type { ProductsByCategoryEndpoint } from '../types';
...
interface Column {
  ...
  render?: (
    value: unknown,
    product: ProductsByCategoryEndpoint
  ) => React.ReactNode;
}
...
const ProductsTable: React.FC<ProductsTableProps> = ({
  ...
  const defaultColumns: Column[] = [
    ...
    // Note: catalog_id, source, warehouse_stock, parent_product_url, and specification_pdfs
    // are not returned by the /products/by-category endpoint, so these columns are hidden
    {
      key: 'scraped_at',
      label: 'Scraped',
      sortable: true,
