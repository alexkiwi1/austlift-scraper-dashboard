 ...
 * @param props.isMinimized - Whether the table is minimized
 * @param props.onToggleMinimize - Function to toggle minimize state
 * @param props.onClose - Function to close the table
 * @param props.columns - Optional custom columns configuration
