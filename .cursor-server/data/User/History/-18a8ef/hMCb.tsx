 ...
 * @returns JSX element containing the products table
 */
const ProductsTable: React.FC<ProductsTableProps> = ({
  ...
  const defaultColumns: Column[] = [
    ...
    { key: 'price', label: 'Price', sortable: true, render: (value) => value ? `$${value.toFixed(2)}` : '-' },
    { key: 'list_price', label: 'List Price', sortable: true, render: (value) => value ? `$${value.toFixed(2)}` : '-' },
    { key: 'dealer_price', label: 'Dealer Price', sortable: true, render: (value) => value ? `$${value.toFixed(2)}` : '-' },
    { key: 'quantity_on_hand', label: 'Stock', sortable: true, width: '80px' },
    { key: 'in_stock', label: 'In Stock', render: (value) => (
    ...
    { key: 'created_at', label: 'Created', sortable: true, render: (value) => 
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-700">
            Showing {startIndex + 1} to {Math.min(endIndex, processedProducts.length)} of{' '}
