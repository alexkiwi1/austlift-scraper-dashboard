...
const AustliftScraperDashboard: React.FC = (): JSX.Element => {
   ...
   * @param defaultColor - The default color class
                  ...
                  <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        {step1Status.message && (
                          <p className={`text-sm ${getStatusColor(step1Status, 'text-blue-600')}`}>
                            {step1Status.message}
                          </p>
                        )}
                      </div>
                  ...
                  <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        {step2Status.message && (
                          <p className={`text-sm ${getStatusColor(step2Status, 'text-green-600')}`}>
                            {step2Status.message}
                          </p>
                        )}
                      </div>
                  ...
                  <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        {step3Status.message && (
                          <p className={`text-sm ${getStatusColor(step3Status, 'text-purple-600')}`}>
                            {step3Status.message}
                          </p>
                        )}
                      </div>
                  ...
                  <div className='flex items-center justify-between p-4 border border-gray-200 rounded-lg'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div>
                        ...
                        {step4Status.message && (
                          <p className={`text-sm ${getStatusColor(step4Status, 'text-orange-600')}`}>
                            {step4Status.message}
                          </p>
                        )}
                      </div>
